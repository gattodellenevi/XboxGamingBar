...
namespace XboxGamingBarHelper.Systems
{
    ...
    internal class SystemManager : Manager
    {
        ...
        private readonly OpenUriProperty openUri;
        public OpenUriProperty OpenUri
        {
            get { return openUri; }
        }

        private readonly RestartElevatedProperty restartElevated;
        public RestartElevatedProperty RestartElevated
        {
